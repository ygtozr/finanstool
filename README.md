...
- Favori kartları ayrı bir tutamaç olmadan yaklaşık 0,4 saniye basılı tutulup sürüklenerek sıralanabilir; kopya yerine gerçek kart parmağı canlı takip eder, komşu kartlar yumuşak biçimde yer açar ve bırakılan kart hedefe oturur. Yeni sıra otomatik olarak cihazda saklanır. Kısa dokunma hızlı detay panelini, normal dikey hareket sayfa kaydırmasını açmaya devam eder.
