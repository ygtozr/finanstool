...
assert.match(html,/amount\.textContent=\(Number\.isFinite\(factor\)\?dividendMoney\(item\.amount\*factor,shownCurrency\)/,'Temettü para tutarı temettüye özel para biçimleyicisini kullanmalı');
