...
- Güncel onaylı sürüm: **v5**.
- Sonraki özellik sürümü, kullanıcı farklı bir ad vermedikçe **v5.1** olur.
...
8. v5 kabul testi kontrol listesi geçer.
9. Güncel belge depo kökünde, aynı belge `archive/v5/` altında bulunur.
