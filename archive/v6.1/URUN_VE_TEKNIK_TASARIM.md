...
- Güncel onaylı sürüm: **v6.1**.
- İncelenen sürüm: **v6.1**.
- Sonraki özellik sürümü, kullanıcı farklı bir ad vermedikçe **v6.2** olur.
...
8. v6.1 kabul testi kontrol listesi geçer.
9. Güncel belge depo kökünde bulunur; kullanıcı onayından sonra aynı belge `archive/v6.1/` altında oluşturulur.
