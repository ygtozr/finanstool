...
- Güncel onaylı sürüm: **v6.6**.
- İncelenen sürüm: **v6.6**.
- Sonraki özellik sürümü, kullanıcı farklı bir ad vermedikçe **v6.7** olur.
...
8. v6.6 kabul testi kontrol listesi geçer.
9. Güncel belge depo kökünde bulunur; kullanıcı onayından sonra aynı belge `archive/v6.6/` altında oluşturulur.
