...
- Güncel onaylı sürüm: **v5.1**.
- Sonraki özellik sürümü, kullanıcı farklı bir ad vermedikçe **v5.2** olur.
...
8. v5.1 kabul testi kontrol listesi geçer.
9. Güncel belge depo kökünde, aynı belge `archive/v5.1/` altında bulunur.
