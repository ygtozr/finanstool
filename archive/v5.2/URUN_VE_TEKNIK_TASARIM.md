...
- Güncel onaylı sürüm: **v5.2**.
- Sonraki özellik sürümü, kullanıcı farklı bir ad vermedikçe **v5.3** olur.
...
8. v5.2 kabul testi kontrol listesi geçer.
9. Güncel belge depo kökünde, aynı belge `archive/v5.2/` altında bulunur.
