...
- Güncel onaylı sürüm: **v6.4**.
- İncelenen sürüm: **v6.4**.
- Sonraki özellik sürümü, kullanıcı farklı bir ad vermedikçe **v6.5** olur.
...
8. v6.4 kabul testi kontrol listesi geçer.
9. Güncel belge depo kökünde bulunur; kullanıcı onayından sonra aynı belge `archive/v6.4/` altında oluşturulur.
