...
- Güncel onaylı sürüm: **v6.2**.
- İncelenen sürüm: **v6.2**.
- Sonraki özellik sürümü, kullanıcı farklı bir ad vermedikçe **v6.3** olur.
...
- iOS ana ekranı için `assets/apple-touch-icon.png` 180×180 boyutundadır. PWA ikonları 192×192 ve 512×512 boyutlarında aynı Özer Finans işaretinden üretilir.
...
8. v6.2 kabul testi kontrol listesi geçer.
9. Güncel belge depo kökünde bulunur; kullanıcı onayından sonra aynı belge `archive/v6.2/` altında oluşturulur.
