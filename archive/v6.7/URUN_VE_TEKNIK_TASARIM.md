...
- Güncel onaylı sürüm: **v6.7**.
- İncelenen sürüm: **v6.7**.
- Sonraki özellik sürümü, kullanıcı farklı bir ad vermedikçe **v6.8** olur.
...
8. v6.7 kabul testi kontrol listesi geçer.
9. Güncel belge depo kökünde bulunur; kullanıcı onayından sonra aynı belge `archive/v6.7/` altında oluşturulur.
