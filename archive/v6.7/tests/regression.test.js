...
assert.match(html,/<title>Özer Finans v6\.7<\/title>/,'Tarayıcı başlığı kalıcı marka ve sürüm adını kullanmalı');
...
console.log('Özer Finans v6.7 regresyon testleri başarılı.');
