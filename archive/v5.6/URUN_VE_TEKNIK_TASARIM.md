...
- Güncel onaylı sürüm: **v5.6**.
- Sonraki özellik sürümü, kullanıcı farklı bir ad vermedikçe **v5.7** olur.
...
8. v5.6 kabul testi kontrol listesi geçer.
9. Güncel belge depo kökünde, aynı belge `archive/v5.6/` altında bulunur.
