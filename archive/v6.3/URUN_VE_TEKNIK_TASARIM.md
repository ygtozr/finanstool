...
- Güncel onaylı sürüm: **v6.3**.
- İncelenen sürüm: **v6.3**.
- Sonraki özellik sürümü, kullanıcı farklı bir ad vermedikçe **v6.4** olur.
...
8. v6.3 kabul testi kontrol listesi geçer.
9. Güncel belge depo kökünde bulunur; kullanıcı onayından sonra aynı belge `archive/v6.3/` altında oluşturulur.
