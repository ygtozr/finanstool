...
- Güncel onaylı sürüm: **v6.5**.
- İncelenen sürüm: **v6.5**.
- Sonraki özellik sürümü, kullanıcı farklı bir ad vermedikçe **v6.6** olur.
...
8. v6.5 kabul testi kontrol listesi geçer.
9. Güncel belge depo kökünde bulunur; kullanıcı onayından sonra aynı belge `archive/v6.5/` altında oluşturulur.
