...
- Güncel onaylı sürüm: **v5.4**.
- Sonraki özellik sürümü, kullanıcı farklı bir ad vermedikçe **v5.5** olur.
...
8. v5.4 kabul testi kontrol listesi geçer.
9. Güncel belge depo kökünde, aynı belge `archive/v5.4/` altında bulunur.
