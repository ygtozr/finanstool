...
- Güncel onaylı sürüm: **v6.0**.
- İncelenen sürüm: **v6.0**.
- Sonraki özellik sürümü, kullanıcı farklı bir ad vermedikçe **v6.1** olur.
...
8. v6.0 kabul testi kontrol listesi geçer.
9. Güncel belge depo kökünde bulunur; kullanıcı onayından sonra aynı belge `archive/v6.0/` altında oluşturulur.
