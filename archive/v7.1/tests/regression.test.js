...
assert.match(html,/<title>Özer Finans v7\.1<\/title>/,'Tarayıcı başlığı kalıcı sürüm adını kullanmalı');
...
console.log('Özer Finans v7.1 Upstash üyelik regresyon testleri başarılı.');
