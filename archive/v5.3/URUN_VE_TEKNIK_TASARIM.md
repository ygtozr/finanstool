...
- Güncel onaylı sürüm: **v5.3**.
- Sonraki özellik sürümü, kullanıcı farklı bir ad vermedikçe **v5.4** olur.
...
8. v5.3 kabul testi kontrol listesi geçer.
9. Güncel belge depo kökünde, aynı belge `archive/v5.3/` altında bulunur.
