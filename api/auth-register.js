...
const { redis, decryptJson, normalizeEmail, validEmail, tokenHash, hashPassword, getUserByEmail, saveUser, createSession, sameOrigin, noStore, publicUser } = require('../lib/auth-store');
