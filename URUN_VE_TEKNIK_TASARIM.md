...
**Belge sürümü:** 7.5
**Uygulama sürümü:** v7.5 Önizleme
**Durum:** İnceleme adayı; v7.4 kalıcı sürüm korunuyor
...
- v7.5 bu aşamada yalnız önizleme adayıdır; kullanıcı onayı verilmeden v7.4 ana yayın ve `v7.4` etiketi değiştirilmez.
