...
- `portfolioMetricsMode` değeri günlük veya toplam kâr-zarar sunumunu belirler. Seçim aktif pozisyon satırlarına, aktif portföy üst özeti ve analiz tablosuna, ayrıca bütün portföylerin birleşik özetine birlikte uygulanır.
...
8. v6.8 kabul testi kontrol listesi geçer.
9. Güncel belge depo kökünde bulunur; kullanıcı onayından sonra aynı belge `archive/v6.8/` altında oluşturulur.
